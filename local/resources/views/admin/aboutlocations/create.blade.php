        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['url' => 'admin/aboutlocations', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-4">
                            <a class="btn btn-danger" href="{{ route('admin.aboutlocations.index') }}">
                                @lang('button.cancel')
                            </a>
